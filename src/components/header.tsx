  ...
  return (
    <header className="header">
      ...
      <div className='parallax'>
        <Parallax className='ok' speed={20}><article id='m1' className="parallax__img" style={{ backgroundImage: `url(${dark1})` }}  >   </article>      </Parallax>
        <Parallax className='ok' speed={10}><article id='m2' className="parallax__img" style={{ backgroundImage: `url(${dark2})` }}>   </article>      </Parallax>
